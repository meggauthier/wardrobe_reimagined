...
personal shopping outings quarterly throughout the year.                </p>
    ...
    <fieldset>      
        <img src="<?php bloginfo('template_directory');?>/Logos/Review.png" width="100%" id="logoPic">
            <div class="rightLation">
                <p> Hourly consultations if you need specific help with:</p>
          
                <br>
                <br>
	          
	     <ul>  <li>Assessing or pulling together the best outfit for a job interview or sales presentation.</li>
    ...
    <fieldset>
         <img src="<?php bloginfo('template_directory');?>/Logos/Relate.png" width="100%" id="logoPic">
            <div class="rightLation">
                <p>Speaking engagements for women’s organizations, corporate events, conferences, and entrepreneur networking groups.</p>
